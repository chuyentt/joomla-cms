...
/**
 * View class for a list of Mapme.
 *
 * @since  1.6
 */
class MapmeViewFeatures extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		MapmeHelper::addSubmenu('features');
	...
	protected function addToolbar()
	{
		...
		$canDo = MapmeHelper::getActions();

		JToolBarHelper::title(JText::_('COM_MAPME_TITLE_FEATURES'), 'features.png');
		...
		if (file_exists($formPath))
		{
			if ($canDo->get('core.create'))
			{
				...
				{
					JToolbarHelper::custom('features.duplicate', 'copy.png', 'copy_f2.png', 'JTOOLBAR_DUPLICATE', true);
				}
			}
		...
		{
			JToolBarHelper::preferences('com_mapme');
		}

		// Set sidebar action - New in 3.0
		JHtmlSidebar::setAction('index.php?option=com_mapme&view=features');
	}
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`title`' => JText::_('COM_MAPME_FEATURES_TITLE'),
		);
	}
