...
$document->addStyleSheet(JUri::root() . 'media/com_mapme/css/form.css');
?>
...
<form
	action="<?php echo JRoute::_('index.php?option=com_mapme&layout=edit&id=' . (int) $this->item->id); ?>"
	method="post" enctype="multipart/form-data" name="adminForm" id="feature-form" class="form-validate">

	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'general')); ?>

		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_MAPME_TITLE_FEATURE', true)); ?>
		<div class="row-fluid">
